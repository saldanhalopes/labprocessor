      ...
      <div className="grid md:grid-cols-3 gap-6 max-w-6xl w-full">
        ...
        <div className="bg-white p-6 rounded-2xl border-2 border-teal-500 shadow-xl relative transform hover:-translate-y-1 transition-transform duration-300 flex flex-col">
          ...
          <ul className="space-y-3 mb-8 text-left flex-1">
            <li className="flex items-center gap-2 text-slate-700"><div className="bg-teal-100 p-1 rounded-full"><Zap className="w-4 h-4 text-teal-600" /></div> Uploads Ilimitados</li>
            <li className="flex items-center gap-2 text-slate-700"><div className="bg-teal-100 p-1 rounded-full"><Check className="w-4 h-4 text-teal-600" /></div> Análise Completa</li>
            <li className="flex items-center gap-2 text-slate-700"><div className="bg-teal-100 p-1 rounded-full"><Check className="w-4 h-4 text-teal-600" /></div> Extração de Reagentes</li>
            <li className="flex items-center gap-2 text-slate-700"><div className="bg-teal-100 p-1 rounded-full"><Check className="w-4 h-4 text-teal-600" /></div> Banco de Dados Persistente</li>
            <li className="flex items-center gap-2 text-slate-700"><div className="bg-teal-100 p-1 rounded-full"><Shield className="w-4 h-4 text-teal-600" /></div> Suporte Prioritário</li>
          </ul>
          <button 
          ...
          >
            {isLoading ? <><Loader2 className="w-5 h-5 animate-spin" /> Redirecionando...</> : <><CreditCard className="w-5 h-5" /> Assinar Profissional</>}
          </button>
        </div>
      </div>
      
      {errorMsg && <div className="mt-6 p-3 bg-red-50 text-red-600 text-sm rounded-lg border border-red-100 max-w-md">{errorMsg}</div>}
      <p className="text-xs text-center text-slate-400 mt-8 mb-4">Pagamento seguro via Stripe. Cancele quando quiser.</p>
      <button onClick={onLogout} className="flex items-center gap-2 text-slate-400 hover:text-red-500 transition-colors text-sm font-medium"><X className="w-4 h-4" /> Deseja sair? Clique aqui para encerrar sessão.</button>
    </div>
  );
};
