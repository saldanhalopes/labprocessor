...
export const translations = {
  ...
  es: {
    ...
    history: {
      ...
      subtitle: 'Registro completo de todos los métodos analizados.',
    ...
    chat: {
      ...
      placeholder: "¿Pregunte sobre sus métodos (ej: '¿Qué equipos se usan en la prueba de pureza del Paracetamol?')...",
  ...
  en: {
    ...
    chat: {
      ...
      placeholder: "Ask about your methods (e.g., 'What equipment is used in the Paracetamol purity test?')...",
